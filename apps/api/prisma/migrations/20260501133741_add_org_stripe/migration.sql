...
-- CreateIndex
CREATE UNIQUE INDEX "app_setting_userId_key_key" ON "app_setting"("userId", "key");
...
-- AddForeignKey
ALTER TABLE "app_setting" ADD CONSTRAINT "app_setting_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
